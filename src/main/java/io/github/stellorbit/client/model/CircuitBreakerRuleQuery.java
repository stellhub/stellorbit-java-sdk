...
public record CircuitBreakerRuleQuery(String serviceName, String operation, RequestContext context) {

    public CircuitBreakerRuleQuery {
    ...
    public Map<String, String> attributes() {
        ...
        RuleQueryAttributes.putIfPresent(attributes, "operation", operation);
